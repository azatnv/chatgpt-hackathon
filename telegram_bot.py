...
Просто попробуй.""",
    ...
    await bot.send_message(
        message.chat.id,
        """
Пока что бот находится в тестовом режиме и работает не стабильно, мы доделываем функционал, скоро все будет работать стабильно. 
Оставайтесь с нами и оставляйте свои пожелания по новым функциям! <3
"""
    )
